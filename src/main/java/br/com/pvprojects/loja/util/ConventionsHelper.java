...
public class ConventionsHelper {
    ...
    public static final String LOGIN_NOT_UNIQUE = "Falha ao alterar o login.";
    ...
    public static final String CAMPO_ACRONIMO_INVALIDO = "O acrônimo do estado é inválido.";
    public static final String CAMPO_ACRONIMO_NAO_INFORMADO = "O acrônimo do estado não foi informado.";
    public static final String CAMPO_ACRONIMO_ESTADO_INVALIDO = "O nome do estado e o acrônimo não correspondem.";
    public static final String CAMPO_ENDERECO_NAO_INFORMADO = "O endereço não foi informado.";
    public static final String CAMPO_ENDERECO_INVALIDO = "Endereço inválido. Por favor, verifique e tente novamente.";
    ...
    public static final String CAMPO_AREA_CEP_INVALIDO = "O código de área do cep é inválido.";
    public static final String CAMPO_AREA_CEP_NAO_INFORMADO = "O código de área do cep não foi informado.";
    public static final String CAMPO_SUFIXO_CEP_INVALIDO = "O sufixo do cep é inválido.";
    public static final String CAMPO_SUFIXO_CEP_NAO_INFORMADO = "O sufixo do cep não foi informado.";
}